...
function ushipnetwork_scripts() {
	wp_enqueue_style( 'ushipnetwork-style', get_stylesheet_uri(), array(), '20161220-02', 'all' );
	...
	wp_enqueue_script( 'ushipnetwork-utilities', get_template_directory_uri() . '/js/utilities.js', array(), '20161207', true );
...
class MvcComponents {
	...
	public static function retrieve_header_footer() {
		...
		$headers = array('Accept-Language: en-MX', 'Accept: application/json');
