...
<section class="bookend">
  <div class="bookend-container">
    ...
    <a class="bookend-cta button buttonPrimary buttonLarge" role="button" href="<?php echo $bookend_cta_url; ?>"><?php the_sub_field('bookend_cta_text'); ?></a>
    ...
    <?php while(have_rows('bookend_previous_content')): the_row(); ?>
      ...
      <a class="bookend-link" role="button" href="<?php echo $bookend_previous_url; ?>">
    ...
    <?php while(have_rows('bookend_next_content')): the_row(); ?>
      ...
      <a class="bookend-link" role="button" href="<?php echo $bookend_next_url; ?>">
