  ...
  <div class="linkRow-container">
    ...
    <?php while(have_rows('link_row_content')): the_row(); ?>
      ...
      <div class="linkRow-block">
        ...
        <a class="linkRow-link emphasisLink" target="_blank" href="<?php echo $link_url; ?>"><?php the_sub_field('link_row_content_text'); ?><?php include( get_template_directory() . '/images/arrow_link.svg'); ?></a>
      </div>
    <?php endwhile; ?>
    </div>
  </div>
